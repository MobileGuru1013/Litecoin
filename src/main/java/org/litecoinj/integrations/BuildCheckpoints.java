...
public class BuildCheckpoints {
    ...
    private static final NetworkParameters PARAMS = LitecoinNetParameters.get();
    private static final File PLAIN_CHECKPOINTS_FILE = new File("/tmp/checkpoints");
    private static final File TEXTUAL_CHECKPOINTS_FILE = new File("/tmp/checkpoints.txt");
    ...
    public static void main(String[] args) throws Exception {
        ...
        peerGroup.addAddress(InetAddress.getByName("debby"));
        ...
        chain.addListener(new AbstractBlockChainListener() {
            ...
            public void notifyNewBestBlock(StoredBlock block) throws VerificationException {
                ...
                if ((height % PARAMS.getInterval() == 2015 || height % PARAMS.getInterval() == 0) && block.getHeader().getTimeSeconds() <= oneMonthAgo) {
